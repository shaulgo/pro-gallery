...
const fixedStyleParams = {
  ...
  groupSize: 1,
  hoveringBehaviour: [GALLERY_CONSTS.INFO_BEHAVIOUR_ON_HOVER.NEVER_SHOW, GALLERY_CONSTS.INFO_BEHAVIOUR_ON_HOVER.APPEARS],
  rotatingGroupTypes: '',
  cubeImages: true,
  smartCrop: false,
  rotatingCubeRatio: '',
  ...
  allowSocial: sp => sp.hoveringBehaviour === GALLERY_CONSTS.INFO_BEHAVIOUR_ON_HOVER.NEVER_SHOW || !sp.allowSocial,
  allowDownload: sp => sp.hoveringBehaviour === GALLERY_CONSTS.INFO_BEHAVIOUR_ON_HOVER.NEVER_SHOW || !sp.allowDownload,
  loveButton: sp => sp.hoveringBehaviour === GALLERY_CONSTS.INFO_BEHAVIOUR_ON_HOVER.NEVER_SHOW || !sp.loveButton,
  loveCounter: sp => sp.hoveringBehaviour === GALLERY_CONSTS.INFO_BEHAVIOUR_ON_HOVER.NEVER_SHOW || !sp.loveCounter,
  itemClick: [GALLERY_CONSTS.ITEM_CLICK.NOTHING, GALLERY_CONSTS.ITEM_CLICK.LINK, GALLERY_CONSTS.ITEM_CLICK.FULLSCREEN, GALLERY_CONSTS.ITEM_CLICK.EXPAND],
  scrollAnimation: GALLERY_CONSTS.SCROLL_ANIMATIONS.NO_EFFECT,
  titlePlacement: sp => [GALLERY_CONSTS.PLACEMENTS.SHOW_ABOVE, GALLERY_CONSTS.PLACEMENTS.SHOW_BELOW].includes(sp.titlePlacement) || sp.hoveringBehaviour === GALLERY_CONSTS.INFO_BEHAVIOUR_ON_HOVER.NEVER_SHOW || (!sp.allowTitle && !sp.allowTitle && !sp.allowDownload && !sp.allowSocial && !sp.loveButton),
  calculateTextBoxHeightMode: sp => sp.calculateTextBoxHeightMode === GALLERY_CONSTS.TEXT_BOX_HEIGHT_CALCULATION_OPTIONS.MANUAL || (sp.titlePlacement !== GALLERY_CONSTS.PLACEMENTS.SHOW_ABOVE && sp.titlePlacement !== GALLERY_CONSTS.PLACEMENTS.SHOW_BELOW),
};
